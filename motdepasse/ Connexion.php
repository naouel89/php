...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($fichier) {
        while (($ligne = fgets($fichier)) !== false) {
            ...
            $emailEnregistre = trim($infosUtilisateur[3]); // Modifier l'indice pour l'email
            $motDePasseEnregistre = trim($infosUtilisateur[4]); // Modifier l'indice pour le mot de passe
